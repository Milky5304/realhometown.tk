...
import { Theme, Link, Button, Image, Text, Box, Icon } from "@quarkly/widgets";
import { Helmet } from "react-helmet";
import { Override, StackItem, Stack, Section, SocialMedia } from "@quarkly/components";
import * as Components from "components";
import { MdMenu } from "react-icons/md";
import { FaDiscord, FaYoutube, FaInstagram, FaTwitter, FaRedditAlien } from "react-icons/fa";
export default (() => {
	return <Theme theme={theme}>
		...
		>
			...
			<Image src="https://uploads.quarkly.io/5fcee1a800ea36001e3b7817/images/5e112790c8b005505027747163965560.png?v=2020-12-16T10:09:51.413Z" width="120px" z-index="3" />
		</Section>
		<Section
		...
		>
			<Override
				slot="SectionContent"
				width="100%"
				background="linear-gradient(180deg,rgba(155, 108, 252, 0.15) 0%,transparent 100%) 0 0 no-repeat,#191C23 url(https://media.discordapp.net/attachments/770311053120634882/788632692593524766/csxzzxc.png?width=819&height=461) center center/cover repeat scroll padding-box"
				height="620px"
				align-items="center"
				justify-content="center"
				sm-width="100%"
			...
			>
				R€ΔŁ ❘❘ HΩMΞTΩWN™ Is A Community Server Here You Can Find New Friends & Spend Your Free Time.
			</Text>
			<Link
				href="https://discord.gg/realop"
				text-decoration-line="initial"
				color="--darkL2"
		...
		>
			...
			<Stack>
				...
				>
					...
					<Box
						width="100%"
						background="--color-lightD2 url(https://media.discordapp.net/attachments/770311052235112459/788718985125560340/5e112790c8b005505027747163965560.png) center center/100% no-repeat"
			...
			<Stack>
				...
				<StackItem width="100%" display="flex">
					...
					<Text
						...
						max-width="720px"
					>
						You can apply for staff by joining our server! Click below to join.
					</Text>
					<Button
		...
		>
			...
			<Stack>
				...
				<StackItem display="flex" quarkly-title="Logo" md-width="50%" width="25%">
					<Override slot="StackItemContent" align-items="center" />
					<Image width="28px" height="28px" src="https://uploads.quarkly.io/5fcee1a800ea36001e3b7817/images/5e112790c8b005505027747163965560.png?v=2020-12-16T10:09:51.413Z" />
					<Link
						href="https://discord.gg/realop/"
						font="--base"
						color="--dark"
